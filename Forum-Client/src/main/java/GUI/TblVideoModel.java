...
class TblVideoModel extends AbstractTableModel {
    ...
    private static final int COL_TITLE = 1;
     ...
     List<Content> contents=ContentServicesDelegate.findAllContents();  //list that is injected via constructor or setter method
