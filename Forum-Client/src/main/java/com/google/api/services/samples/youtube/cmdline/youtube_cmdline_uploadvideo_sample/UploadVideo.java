...
public class UploadVideo {
  ...
  public static void main(String[] args) {
	  ...
	  TestVideo("My Video","Amzing one!", tags, "c:/1.mp4" );

  }
  
  public static void  TestVideo(String title, String description, List<String> keywords,String abspath)
  {
   ...
   */
  private static File getVideoFromUser(String abspath) throws IOException {
    File[] listOfVideoFiles = getLocalVideoFiles(abspath);
   ...
   */
  private static File[] getLocalVideoFiles(String abspath) throws IOException {

    File currentDirectory = new File(abspath);
